...
const Navbar = () =>{
    ...
    const navItems = <>
            ...
            {user?.uid ? <>
                {condition?.role ==="recruiter" && <Link to={"/dashboard"}><li className={`listItem ${menu? "text-black dark:text-white": "text-white lg:text-black"} `}>Dashboard</li></Link>}
                {condition?.role === "seeker" && <Link to={"/employedashboard"}><li className={`listItem ${menu ? "text-black" : "text-white lg:text-black"} `}>Dashboard</li></Link>}
                ...
                <Link to={`/profile/${user?.email}`}><li className={`listItem ${menu ? "text-black" : "text-white lg:text-black"} `}>Profile</li></Link>
